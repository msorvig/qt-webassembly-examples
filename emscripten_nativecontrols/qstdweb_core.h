...
namespace qstdweb {
    ...
    public:
        ...
        void onLoad(const std::function<void (const emscripten::val& event)> &onLoad);
        void onError(const std::function<void (const emscripten::val& event)> &onError);
        void onAbort(const std::function<void (const emscripten::val& event)> &onAbort);
    ...
    {
    public:
        EventCallback(const emscripten::val &element, const std::string &name, const std::function<void (const emscripten::val&)> &fn);
        ~EventCallback();
        static void activate(const emscripten::val& event);
    ...
    private:
        ...
        std::string m_name;
        std::function<void (const emscripten::val&)> m_fn;
    };
}
